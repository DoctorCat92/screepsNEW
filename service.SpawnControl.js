var serviceSpawnControl = {
    ...
    run: function (process) {
        ...
        {
            harvester:  {role: 'support', roomNumber: 'W19S7', priority: 1, count: 3, staffed: [], charact: [CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE], options: 3, }, //CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE
